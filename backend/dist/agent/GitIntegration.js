    ...
    setupGitConfig() {
        try {
            ...
            if (GITHUB_TOKEN && GITHUB_REPO) {
                ...
                try {
                    (0, child_process_1.execSync)('git fetch origin main', { cwd: this.projectRoot, encoding: 'utf-8', stdio: 'pipe', timeout: 30000 });
                    // Set upstream tracking
                    (0, child_process_1.execSync)('git branch --set-upstream-to=origin/main main', { cwd: this.projectRoot, encoding: 'utf-8', stdio: 'pipe' });
                }
                catch (e) {
